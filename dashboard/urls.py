...
urlpatterns = [
    ...
    path('plataformas/', views.platform_list, name='platform_list'),
    path('plataformas/nueva/', views.platform_create, name='platform_create'),
    path('plataformas/<int:pk>/editar/', views.platform_edit, name='platform_edit'),
    path('plataformas/<int:pk>/eliminar/', views.platform_delete, name='platform_delete'),
