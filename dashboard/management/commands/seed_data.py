...
GAMES = [
    ...
    {'name': 'Resident Evil 4 Remake', 'description': 'Revive la icónica aventura de survival horror con gráficos renovados y nuevas mecánicas de juego.', 'price': 59.99, 'discount': 40, 'developer': 'Capcom', 'publisher': 'Capcom', 'release': '2023-03-24', 'rating': 9.4, 'video': 'https://www.youtube.com/embed/fPuMGfStaHk', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['terror', 'accion', 'aventura'], 'category': 'Juegos Premium'},
    {'name': 'Starfield', 'description': 'Explora el vasto espacio exterior en esta épica aventura de rol de Bethesda Game Studios.', 'price': 69.99, 'discount': 30, 'developer': 'Bethesda Game Studios', 'publisher': 'Bethesda Softworks', 'release': '2023-09-06', 'rating': 8.5, 'video': 'https://www.youtube.com/embed/kfYEiTdsyas', 'platforms': ['pc', 'xbox'], 'genres': ['rpg', 'aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    ...
    {'name': 'Stardew Valley', 'description': 'Deja la ciudad y vive tus sueños agrícolas en el campo. Cultiva, cría animales y haz amigos.', 'price': 14.99, 'discount': 0, 'developer': 'ConcernedApe', 'publisher': 'ConcernedApe', 'release': '2016-02-26', 'rating': 9.8, 'video': 'https://www.youtube.com/embed/ot7uXNQskhs', 'platforms': ['pc', 'ps5', 'xbox', 'switch', 'android'], 'genres': ['simulacion', 'indie'], 'category': 'Indie'},
    ...
    {'name': 'Counter-Strike 2', 'description': 'El shooter táctico por excelencia renace con gráficos mejorados y nuevas mecánicas.', 'price': 0, 'discount': 0, 'developer': 'Valve', 'publisher': 'Valve', 'release': '2023-09-27', 'rating': 9.1, 'video': 'https://www.youtube.com/embed/nSE38xjMLqE', 'platforms': ['pc'], 'genres': ['shooter', 'accion', 'estrategia'], 'category': 'Free to Play'},
