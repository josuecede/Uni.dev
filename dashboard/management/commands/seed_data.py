...
COVER_URLS = {
    ...
    'Baldur\'s Gate 3': 'https://cdn.cloudflare.steamstatic.com/steam/apps/1086940/library_600x900.jpg',
    'Call of Duty: Modern Warfare III': 'https://cdn.cloudflare.steamstatic.com/steam/apps/2519060/library_600x900.jpg',
    'FIFA 24': 'https://cdn.cloudflare.steamstatic.com/steam/apps/2195250/library_600x900.jpg',
    'Horizon Forbidden West': 'https://cdn.cloudflare.steamstatic.com/steam/apps/2420110/library_600x900.jpg',
    'Resident Evil 4 Remake': 'https://cdn.cloudflare.steamstatic.com/steam/apps/2050650/library_600x900.jpg',
    'Starfield': 'https://cdn.cloudflare.steamstatic.com/steam/apps/1716740/library_600x900.jpg',
    'Mortal Kombat 1': 'https://cdn.cloudflare.steamstatic.com/steam/apps/1971870/library_600x900.jpg',
    'Hogwarts Legacy': 'https://cdn.cloudflare.steamstatic.com/steam/apps/990080/library_600x900.jpg',
    'Stray': 'https://cdn.cloudflare.steamstatic.com/steam/apps/1332010/library_600x900.jpg',
    ...
    'Assassin\'s Creed Mirage': 'https://cdn.cloudflare.steamstatic.com/steam/apps/3032940/library_600x900.jpg',
    'Forza Motorsport': 'https://images.launchbox-app.com/70192416-e329-483b-b775-9d3ad2005bc6.jpg',
    'Gran Turismo 7': 'https://images.launchbox-app.com/4211ae53-61d4-4377-808f-e92d878ca5ed.jpg',
    'Spider-Man 2': 'https://images.launchbox-app.com/c56908bd-7737-45f6-a42b-bcebe044d59d.jpg',
    'The Legend of Zelda: Tears of the Kingdom': 'https://images.launchbox-app.com/20c45766-0bc0-410d-ab7c-58b6a4855f75.png',
...
GAMES = [
    {'name': 'Cyberpunk 2077', 'description': 'Sumérgete en Night City, una megalópolis obsesionada con el poder, el glamour y las modificaciones corporales. Juega como V, un mercenario forajido en busca de un implante único que es la llave de la inmortalidad.', 'price': 59.99, 'discount': 40, 'developer': 'CD Projekt Red', 'publisher': 'CD Projekt', 'release': '2020-12-10', 'rating': 8.6, 'video': 'https://www.youtube-nocookie.com/embed/8X2kIfS6fb8', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['rpg', 'accion', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Elden Ring', 'description': 'Álzate, Sinluz, y adéntrate en las Tierras Intermedias. Un mundo de fantasía épica creado por Hidetaka Miyazaki y George R.R. Martin.', 'price': 69.99, 'discount': 25, 'developer': 'FromSoftware', 'publisher': 'Bandai Namco', 'release': '2022-02-25', 'rating': 9.8, 'video': 'https://www.youtube-nocookie.com/embed/UhD0_MM4fnU', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['rpg', 'accion', 'aventura'], 'category': 'Juegos Premium'},
    {'name': 'God of War Ragnarök', 'description': 'Kratos y Atreus se embarcan en un viaje épico a través de los nueve reinos en busca de respuestas.', 'price': 69.99, 'discount': 20, 'developer': 'Santa Monica Studio', 'publisher': 'Sony Interactive Entertainment', 'release': '2022-11-09', 'rating': 9.6, 'video': 'https://www.youtube-nocookie.com/embed/g1wr0DfV73E', 'platforms': ['ps5', 'pc'], 'genres': ['accion', 'aventura'], 'category': 'Juegos Premium'},
    {'name': 'The Legend of Zelda: Tears of the Kingdom', 'description': 'Explora un mundo lleno de maravillas mientras Link descubre los secretos de Hyrule en esta épica aventura.', 'price': 69.99, 'discount': 10, 'developer': 'Nintendo EPD', 'publisher': 'Nintendo', 'release': '2023-05-12', 'rating': 9.9, 'video': 'https://www.youtube-nocookie.com/embed/uHGShqcAHlQ', 'platforms': ['switch'], 'genres': ['aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Red Dead Redemption 2', 'description': 'Vive la épica historia del forajido Arthur Morgan en el Salvaje Oeste. Un mundo abierto inmersivo con una narrativa inolvidable.', 'price': 59.99, 'discount': 50, 'developer': 'Rockstar Games', 'publisher': 'Rockstar Games', 'release': '2018-10-26', 'rating': 9.7, 'video': 'https://www.youtube-nocookie.com/embed/eaW0tYpxyp0', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['accion', 'aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Spider-Man 2', 'description': 'Peter Parker y Miles Morales se unen para enfrentar a Venom y proteger la ciudad de Nueva York.', 'price': 69.99, 'discount': 15, 'developer': 'Insomniac Games', 'publisher': 'Sony Interactive Entertainment', 'release': '2023-10-20', 'rating': 9.5, 'video': 'https://www.youtube-nocookie.com/embed/9fVYKsEmuRo', 'platforms': ['ps5'], 'genres': ['accion', 'aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Baldur\'s Gate 3', 'description': 'Reúne a tu grupo y regresa a los Reinos Olvidados en esta historia de amistad, traición y sacrificio.', 'price': 59.99, 'discount': 10, 'developer': 'Larian Studios', 'publisher': 'Larian Studios', 'release': '2023-08-03', 'rating': 9.9, 'video': 'https://www.youtube-nocookie.com/embed/NOWGnC3h9WQ', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['rpg', 'estrategia'], 'category': 'Juegos Premium'},
    {'name': 'Call of Duty: Modern Warfare III', 'description': 'La amenaza continúa mientras el Capitán Price y la Task Force 141 enfrentan a Vladimir Makarov.', 'price': 69.99, 'discount': 30, 'developer': 'Sledgehammer Games', 'publisher': 'Activision', 'release': '2023-11-10', 'rating': 7.8, 'video': 'https://www.youtube-nocookie.com/embed/ITIcmA4Zwa8', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['shooter', 'accion'], 'category': 'Juegos Premium'},
    {'name': 'FIFA 24', 'description': 'La experiencia de fútbol más auténtica con nuevas mecánicas de juego, modos mejorados y los mejores equipos del mundo.', 'price': 69.99, 'discount': 35, 'developer': 'EA Sports', 'publisher': 'Electronic Arts', 'release': '2024-09-27', 'rating': 8.5, 'video': 'https://www.youtube-nocookie.com/embed/XhP3Xh4LMA8', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['deportes'], 'category': 'Juegos Premium'},
    {'name': 'Forza Motorsport', 'description': 'Vive la velocidad con el simulador de carreras más avanzado. Más de 500 coches y 20 circuitos.', 'price': 69.99, 'discount': 30, 'developer': 'Turn 10 Studios', 'publisher': 'Xbox Game Studios', 'release': '2023-10-10', 'rating': 9.2, 'video': 'https://www.youtube-nocookie.com/embed/13Qzm2qqXA4', 'platforms': ['pc', 'xbox'], 'genres': ['carreras', 'simulacion'], 'category': 'Juegos Premium'},
    {'name': 'Horizon Forbidden West', 'description': 'Aloy se aventura en el Oeste Prohibido para descubrir los secretos que amenazan la vida en la Tierra.', 'price': 59.99, 'discount': 35, 'developer': 'Guerrilla Games', 'publisher': 'Sony Interactive Entertainment', 'release': '2022-02-18', 'rating': 9.3, 'video': 'https://www.youtube-nocookie.com/embed/Lq594XmpPBg', 'platforms': ['ps5', 'pc'], 'genres': ['accion', 'aventura', 'rpg'], 'category': 'Juegos Premium'},
    {'name': 'Resident Evil 4 Remake', 'description': 'Revive la icónica aventura de survival horror con gráficos renovados y nuevas mecánicas de juego.', 'price': 59.99, 'discount': 40, 'developer': 'Capcom', 'publisher': 'Capcom', 'release': '2023-03-24', 'rating': 9.4, 'video': 'https://www.youtube-nocookie.com/embed/fPuMGfStaHk', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['terror', 'accion', 'aventura'], 'category': 'Juegos Premium'},
    {'name': 'Starfield', 'description': 'Explora el vasto espacio exterior en esta épica aventura de rol de Bethesda Game Studios.', 'price': 69.99, 'discount': 30, 'developer': 'Bethesda Game Studios', 'publisher': 'Bethesda Softworks', 'release': '2023-09-06', 'rating': 8.5, 'video': 'https://www.youtube-nocookie.com/embed/kfYEiTdsyas', 'platforms': ['pc', 'xbox'], 'genres': ['rpg', 'aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Mortal Kombat 1', 'description': 'Un nuevo universo de kombate te espera. Gráficos impresionantes y un sistema de lucha revolucionario.', 'price': 69.99, 'discount': 40, 'developer': 'NetherRealm Studios', 'publisher': 'Warner Bros. Games', 'release': '2023-09-19', 'rating': 8.7, 'video': 'https://www.youtube-nocookie.com/embed/UZ6eFEjFfJ0', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['accion'], 'category': 'Juegos Premium'},
    {'name': 'Assassin\'s Creed Mirage', 'description': 'Vive la historia de Basim en el Bagdad del siglo IX en esta vuelta a las raíces de la saga.', 'price': 49.99, 'discount': 40, 'developer': 'Ubisoft Bordeaux', 'publisher': 'Ubisoft', 'release': '2023-10-05', 'rating': 8.8, 'video': 'https://www.youtube-nocookie.com/embed/IRNOoOYVn80', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['accion', 'aventura'], 'category': 'Juegos Premium'},
    {'name': 'Hogwarts Legacy', 'description': 'Vive tu propia aventura en el Mundo Mágico. Explora Hogwarts y descubre secretos ocultos.', 'price': 59.99, 'discount': 40, 'developer': 'Avalanche Software', 'publisher': 'Warner Bros. Games', 'release': '2023-02-10', 'rating': 9.0, 'video': 'https://www.youtube-nocookie.com/embed/1O6Qstncpnc', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['rpg', 'aventura', 'mundo-abierto'], 'category': 'Juegos Premium'},
    {'name': 'Gran Turismo 7', 'description': 'La experiencia de conducción definitiva con más de 400 coches y 100 circuitos.', 'price': 69.99, 'discount': 30, 'developer': 'Polyphony Digital', 'publisher': 'Sony Interactive Entertainment', 'release': '2022-03-04', 'rating': 9.1, 'video': 'https://www.youtube-nocookie.com/embed/1tBUsXIkG1A', 'platforms': ['ps5'], 'genres': ['carreras', 'simulacion'], 'category': 'Juegos Premium'},
    {'name': 'Stray', 'description': 'Juega como un gato callejero en una ciudad cyberpunk llena de robots y misterios.', 'price': 29.99, 'discount': 20, 'developer': 'BlueTwelve Studio', 'publisher': 'Annapurna Interactive', 'release': '2022-07-19', 'rating': 9.0, 'video': 'https://www.youtube-nocookie.com/embed/XgPRPi--F5E', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['aventura', 'indie'], 'category': 'Indie'},
    {'name': 'Hollow Knight', 'description': 'Adéntrate en el reino de Hallownest, un mundo subterráneo lleno de insectos y misterios.', 'price': 14.99, 'discount': 30, 'developer': 'Team Cherry', 'publisher': 'Team Cherry', 'release': '2017-02-24', 'rating': 9.5, 'video': 'https://www.youtube-nocookie.com/embed/UAO2urG23S4', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['aventura', 'accion', 'indie'], 'category': 'Indie'},
    {'name': 'Stardew Valley', 'description': 'Deja la ciudad y vive tus sueños agrícolas en el campo. Cultiva, cría animales y haz amigos.', 'price': 14.99, 'discount': 0, 'developer': 'ConcernedApe', 'publisher': 'ConcernedApe', 'release': '2016-02-26', 'rating': 9.8, 'video': 'https://www.youtube-nocookie.com/embed/ot7uXNQskhs', 'platforms': ['pc', 'ps5', 'xbox', 'switch', 'android'], 'genres': ['simulacion', 'indie'], 'category': 'Indie'},
    {'name': 'Celeste', 'description': 'Ayuda a Madeline a escalar la Montaña Celeste en este desafiante y conmovedor juego de plataformas.', 'price': 19.99, 'discount': 30, 'developer': 'Maddy Makes Games', 'publisher': 'Maddy Makes Games', 'release': '2018-01-25', 'rating': 9.6, 'video': 'https://www.youtube-nocookie.com/embed/70d9irlxiB4', 'platforms': ['pc', 'ps5', 'xbox', 'switch'], 'genres': ['accion', 'indie'], 'category': 'Indie'},
    {'name': 'Counter-Strike 2', 'description': 'El shooter táctico por excelencia renace con gráficos mejorados y nuevas mecánicas.', 'price': 0, 'discount': 0, 'developer': 'Valve', 'publisher': 'Valve', 'release': '2023-09-27', 'rating': 9.1, 'video': 'https://www.youtube-nocookie.com/embed/nSE38xjMLqE', 'platforms': ['pc'], 'genres': ['shooter', 'accion', 'estrategia'], 'category': 'Free to Play'},
    {'name': 'Fortnite', 'description': 'El battle royale más popular del mundo. Construye, lucha y sé el último en pie.', 'price': 0, 'discount': 0, 'developer': 'Epic Games', 'publisher': 'Epic Games', 'release': '2017-07-25', 'rating': 8.9, 'video': 'https://www.youtube-nocookie.com/embed/WJW-bzXZM8M', 'platforms': ['pc', 'ps5', 'xbox', 'switch', 'android'], 'genres': ['shooter', 'accion'], 'category': 'Free to Play'},
    {'name': 'Genshin Impact', 'description': 'Explora el mundo de Teyvat y descubre sus secretos en este RPG de acción gratuito.', 'price': 0, 'discount': 0, 'developer': 'miHoYo', 'publisher': 'miHoYo', 'release': '2020-09-28', 'rating': 9.3, 'video': 'https://www.youtube-nocookie.com/embed/HLUY1nICQRY', 'platforms': ['pc', 'ps5', 'android'], 'genres': ['rpg', 'accion', 'mundo-abierto'], 'category': 'Free to Play'},
    {'name': 'Grand Theft Auto V', 'description': 'Tres criminales, una ciudad. Vive la historia de Michael, Franklin y Trevor en Los Santos.', 'price': 29.99, 'discount': 50, 'developer': 'Rockstar North', 'publisher': 'Rockstar Games', 'release': '2013-09-17', 'rating': 9.8, 'video': 'https://www.youtube-nocookie.com/embed/hvoD7ehZPcM', 'platforms': ['pc', 'ps5', 'xbox'], 'genres': ['accion', 'aventura', 'mundo-abierto'], 'category': 'Clásicos'},
]
...
def generate_placeholder(color, size=(1920, 1080)):
...
def get_gallery_images(color):
    imgs = []
    for _ in range(4):
        imgs.append(generate_placeholder(color, (1920, 1080)))
    return imgs
